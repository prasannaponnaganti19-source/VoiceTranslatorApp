...
class CallScreen(BoxLayout):
    def __init__(self, **kwargs):
        super().__init__(orientation="vertical", padding=30, spacing=25)
        ...
        self.log = Label(text="", font_size="16sp", color=(1,1,1,1),
        ...
        self.answer_btn = Button(text="Answer", background_color=(0,0.7,0.3,1), font_size="20sp")
        self.end_btn = Button(text="End", background_color=(0.9,0.2,0.2,1), font_size="20sp")
    ...
    def live_translate(self):
        ...
        while self.call_active:
            try:
                spoken_text = "Hello, this is a demo"  # placeholder
